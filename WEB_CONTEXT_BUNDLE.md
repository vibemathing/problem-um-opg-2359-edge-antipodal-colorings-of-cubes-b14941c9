...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-2359-edge-antipodal-colorings-of-cubes-b14941c9-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-2359"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-2359-edge-antipodal-colorings-of-cubes-b14941c9-v1",
      "problem_contract_sha256": "2574b66ee7e9f1d6ec8311ffdd17ff844e2091766133d33203bf458e6bfbcb19",
      "problem_id": "problem:um-opg-2359-edge-antipodal-colorings-of-cubes-b14941c9",
      "route_id": "route:um-opg-2359-edge-antipodal-colorings-of-cubes-b14941c9-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-2359-edge-antipodal-colorings-of-cubes-b14941c9-source-fidelity-01",
      "graph_id": "graph:um-opg-2359-edge-antipodal-colorings-of-cubes-b14941c9-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-2359-edge-antipodal-colorings-of-cubes-b14941c9-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-2359-edge-antipodal-colorings-of-cubes-b14941c9-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "We let $Q_d$ denote the $d$-dimensional cube graph. A map $\\phi: E(Q_d) \\rightarrow \\{0,1\\}$ is called edge-antipodal if $\\phi(e) \\neq \\phi(e')$ whenever $e,e'$ are antipodal edges. Conjecture If $d \\ge 2$ and $\\phi: E(Q_d) \\rightarrow \\{0,1\\}$ is edge-antipodal, then there exist a pair of antipodal vertices $v,v' \\in V(Q_d)$ which are joined by a monochromatic path."
          },
          "statement_sha256": "74ae52fb9924f8da0027400f49e15c5efd1742bbd55d3c800a1e67481869f6c7"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-2359-edge-antipodal-colorings-of-cubes-b14941c9-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-2359-edge-antipodal-colorings-of-cubes-b14941c9-root",
      "route_id": "route:um-opg-2359-edge-antipodal-colorings-of-cubes-b14941c9-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-2359-efbf4a3f2fae",
        "url": "https://www.unsolvedmath.com/problems/OPG-2359"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
